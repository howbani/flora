...
using FLORA.Coverage;
using FLORA.Properties;
using System.Windows.Media;
using System.Windows.Threading;
using FLORA.Forwarding;
using FLORA.ExpermentsResults.Energy_consumptions;
using FLORA.ExpermentsResults.Lifetime;
using FLORA.ControlPlane.NOS.TC;
using FLORA.ControlPlane.NOS.TC.subgrapgh;
using FLORA.DataPlane.NeighborsDiscovery;
using FLORA.ControlPlane.NOS.FlowEngin;
using FLORA.ui.conts;
using FLORA.Charts.Intilization;
using FLORA.ControlPlane.NOS.Visualizating;
...
namespace FLORA.ui
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public Int32 stopSimlationWhen = 1000000000; // s by defult1000000000.
        ...
        private void TimerCounter_Tick(object sender, EventArgs e)
        {
            if (PublicParamerters.SimulationTime <= stopSimlationWhen + PublicParamerters.MacStartUp)
            {
                ...
                Dispatcher.Invoke(() => Title = "FLORA:" + PublicParamerters.SimulationTime.ToString(), DispatcherPriority.Send);
            }
            else
            {
                TimerCounter.Stop();
        ...
        public void RandomDeplayment(int sinkIndex)
        {
            ...
            PublicParamerters.PowersString = PublicParamerters.NetworkName.ToString();
            ...
            WeightsComputations.computeWeights(myNetWork, 11);
            ...
            Console.WriteLine(PublicParamerters.DataPacketDuration.ToString());
